...
<body>
<div class="main">
    <p><strong><img src=<?php echo e($logo); ?> caption="false" width="209" height="39"/></strong></p>
    <br/><br/>
    <p><strong><span style="font-size: 12pt;">Dear <?php echo $data1[0]['name']?>,</span></strong></p>
